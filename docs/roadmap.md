...
## Next enhancements — approved sequence

1. **Reliability — merged in PR #40.** Atomic imports, household isolation, consistent totals and protected manual choices. Production migration status still needs verification.
2. **ANZ automatic imports — implemented in PR #41, awaiting review/deployment.** Akahu Personal App, explicit account mapping, settled transactions, resumable daily imports, correction/deletion reconciliation and visible bank-data freshness. CSV/PDF remains available. Live credentials and consent are deployment steps.
3. **Transaction catch-up on login.** A card-based review queue inspired by Tinder/Slack catch-up: confirm, correct category, skip and undo. Remember review progress; distinguish newly imported transactions from material bank corrections.
4. **Weekly update emails — confirmed 2026-09-18.** A short household update using automatically imported transactions: month-to-date income, spending and net position; categories doing well or exceeding budgets; budget remaining and clearly labelled spending-pace estimates; and the number of transactions needing review, linked to catch-up. Include bank freshness and incomplete-import warnings so missing data never reads as good performance. Reuse the same financial calculations as the app, including refunds and transfer exclusions. Send on a household-selected weekly schedule in Pacific/Auckland, with per-recipient opt-in/unsubscribe, household membership checks and duplicate-safe delivery/retries. Build after automatic imports and persisted review state. Email provider setup and live delivery are separate activation steps; no emails are enabled by this roadmap change.

## Future / Far Future

| Feature                      | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Additional bank integrations | ANZ through Akahu is now in the approved sequence above. Other banks and broader app access remain deferred.                                                                                                                                                                                                                                                                                                                                                          |
...
| Push notifications           | Weekly email updates are now in the approved sequence above; push notifications remain deferred.                                                                                                                                                                                                                                                                                                                                                                      |
