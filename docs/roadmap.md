...
2. **ANZ automatic imports — in progress.** Akahu Personal App, explicit account mapping, settled transactions, resumable daily imports, correction/deletion reconciliation and visible bank-data freshness. CSV/PDF remains available. Live credentials and consent are deployment steps.
